...
def elbow_curve(encoded_samples, max_values=70, fig_size=(10, 5)):
    """
    Function that is used to find the number of potential
    clusters fo an unsupervised clustering such as K-Means
    """
    np.random.seed(0)
    inertia_values = []
...
def translate_labels(translation_list, model_results):
    """
    Function that is used to translate user defined labels
    and user labelled predicted values
    """
...
def generate_precision_dataframe(
    ...
    """
    Function that generates the precision dataframe containing
    precision values of all 14 classes generated by each of
    the input models
    """
