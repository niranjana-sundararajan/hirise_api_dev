...
class HIRISEimage:
    ...
    def get_file_parameters(self, local_database_path = None):
        ...
        return {
            ...
            "IMG_SIZE":  humanize.naturalsize(observation_values['REQUIRED_STORAGE_BYTES']),
            "REQUIRED_STORAGE_BYTES" : observation_values['REQUIRED_STORAGE_BYTES'].values[0],
    ...
    def get_timing_parameters(self, local_database_path = None):
        ...
        observation_values = hirise_df[hirise_df["FILE_NAME"] == self.file_name]
        return {
            "MRO:OBSERVATION_START_TIME" :observation_values["MRO:OBSERVATION_START_TIME"].values[0], 
            "START_TIME" :observation_values["START_TIME"].values[0], 
            "SPACECRAFT_CLOCK_START_COUNT" :observation_values["SPACECRAFT_CLOCK_START_COUNT"].values[0], 
            "STOP_TIME" :observation_values["STOP_TIME"].values[0], 
            "SPACECRAFT_CLOCK_STOP_COUNT" :observation_values["SPACECRAFT_CLOCK_STOP_COUNT"].values[0], 
            "PRODUCT_CREATION_TIME" :observation_values["PRODUCT_CREATION_TIME"].values[0],
        }
    ...
    def get_other_parameters(self, local_database_path = None):
        ...
        return {
            ...
            "CENTER_FILTER_WAVELENGTH" :observation_values["CENTER_FILTER_WAVELENGTH"].values[0]
        }
    ...
    def get_all_parameters(self, local_database_path = None):
        ...
        return {
            "FILE_NAME" : self.file_name, 
            "IMG_SIZE":  humanize.naturalsize(int(observation_values['REQUIRED_STORAGE_BYTES'].values[0])),
            "REQUIRED_STORAGE_BYTES" : observation_values['REQUIRED_STORAGE_BYTES'].values[0],
            "MISSION_PHASE_NAME" :observation_values["MISSION_PHASE_NAME"].values[0], 
            "ORBIT_NUMBER" :observation_values["ORBIT_NUMBER"].values[0],
            "ORBITAL_RANGE" :observation_values["ORBITAL_RANGE"].values[0],
            ...
            "EASTERNMOST_LONGITUDE" :observation_values["EASTERNMOST_LONGITUDE"].values[0], 
            "WESTERNMOST_LONGITUDE" :observation_values["WESTERNMOST_LONGITUDE"].values[0], 
            "INCIDENCE_ANGLE" :observation_values["INCIDENCE_ANGLE"].values[0], 
            "EMISSION_ANGLE" :observation_values["EMISSION_ANGLE"].values[0],
            "PHASE_ANGLE" :observation_values["PHASE_ANGLE"].values[0], 
            "LOCAL_TIME": observation_values["LOCAL_TIME"].values[0],
